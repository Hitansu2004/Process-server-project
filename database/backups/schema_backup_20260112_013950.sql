...
CREATE TABLE `orders` (
  ...
  `status` enum('OPEN','BIDDING','PARTIALLY_ASSIGNED','ASSIGNED','IN_PROGRESS','COMPLETED','FAILED','CANCELLED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `order_drafts` (
  ...
  `tenant_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `customer_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `draft_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `current_step` int NOT NULL DEFAULT 1,
  `is_complete` tinyint(1) NOT NULL DEFAULT 0,
  `document_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recipients_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `service_options_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `expires_at` timestamp NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_drafts_customer` (`customer_id`),
  KEY `idx_drafts_tenant` (`tenant_id`),
  KEY `idx_drafts_expires` (`expires_at`),
  KEY `idx_drafts_updated` (`updated_at`),
  KEY `idx_drafts_customer_updated` (`customer_id`, `updated_at` DESC),
  CONSTRAINT `fk_drafts_customer` FOREIGN KEY (`customer_id`) REFERENCES `tenant_user_roles` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_drafts_tenant` FOREIGN KEY (`tenant_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-01-12 (Updated with order_drafts table)
